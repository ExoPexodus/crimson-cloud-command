  ...
  return (
    <Card className="glass-card shadow-lg">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Switch 
              ...
              className="data-[state=checked]:bg-dark-blue-500"
            />
          </div>
        </div>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="rules">
          <TabsList className="bg-dark-bg mb-4">
            <TabsTrigger value="rules" className="data-[state=active]:bg-dark-blue-800/30 data-[state=active]:text-dark-blue-50">
              <RefreshCw size={16} className="mr-2" />
              Scaling Rules
            </TabsTrigger>
            <TabsTrigger value="monitoring" className="data-[state=active]:bg-dark-blue-800/30 data-[state=active]:text-dark-blue-50">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-dark-bg/60 border-dark-bg-light/40 focus-visible:ring-dark-blue-500"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  className="[&>span]:bg-dark-blue-500"
                />
              </div>
          ...
          <TabsContent value="monitoring">
            <div className="space-y-4">
              ...
              <div className="rounded-md border border-dark-bg-light/30 bg-dark-bg/60 p-4 text-center">
                ...
                <Button variant="outline" className="mt-2 text-xs border-dark-blue-700/50 hover:bg-dark-blue-800/20">
                  Connect API
                </Button>
              </div>
            </div>
      ...
      <CardFooter className="border-t border-dark-bg-light/30 pt-4">
        <Button 
          onClick={handleSave} 
          className="bg-dark-blue-600 hover:bg-dark-blue-700 text-white ml-auto"
        >
